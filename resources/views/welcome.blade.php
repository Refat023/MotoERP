...
<head>
    ...
    <title>Super Shop POS - Welcome</title>
    ...
    <div class="landing-container">
        <div class="welcome-card">
            <div class="welcome-header">
                ...
                <div class="features-row">
                    ...
                    <div class="feature-item">
                        ...
                        <h3>Analytics</h3>
                        <p>Sales insights & reports</p>
                    </div>
                </div>

                <div class="cta-buttons">
                    <a href="{{ route('login') }}" class="btn-cta btn-login">
                        <i class="bi bi-box-arrow-in-right"></i> Login
                    </a>
                    <a href="{{ route('register') }}" class="btn-cta btn-register">
            ...
            <div class="welcome-footer">
                <p class="mb-2">
                    <strong>Super Shop POS System</strong> - Manage your business efficiently
                </p>
                <p class="mb-0">
                    © 2024 Super Shop. All rights reserved.
                </p>
            </div>
        </div>
    </div>
